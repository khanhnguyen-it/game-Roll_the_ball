...
RollTheBall.prototype.error = function (message) {

    if (this.alert_errors) alert(message);
    if (this.log_info) console.log(message);
};

RollTheBall.prototype.log = function (message) {

    if (this.log_info) console.log(message);
};

RollTheBall.prototype.set_viewport = function (x, y) {

    this.viewport.x = x;
    this.viewport.y = y;
};

RollTheBall.prototype.keydown = function (e) {
...
RollTheBall.prototype.keyup = function (e) {
...
RollTheBall.prototype.load_map = function (map) {
...
RollTheBall.prototype.get_tile = function (x, y) {

    return (this.current_map.data[y] && this.current_map.data[y][x]) ? this.current_map.data[y][x] : 0;
};

RollTheBall.prototype.draw_tile = function (x, y, tile, context) {
...
RollTheBall.prototype.draw_map = function (context, fore) {
...
RollTheBall.prototype.move_player = function () {
...
RollTheBall.prototype.update_player = function () {
...
RollTheBall.prototype.draw_player = function (context) {
...
RollTheBall.prototype.update = function () {

    this.update_player();
};

RollTheBall.prototype.draw = function (context) {
